    ...
    <div class="vh-100 d-flex align-items-center justify-content-center">
        <div class="text-white text-center" style="z-index: 1100 !important;">
            ...
            <form method="post" action="<?php echo base_url(); ?>analytic/upload" enctype="multipart/form-data" class="row g-1">
                ...
                <div class="col">
                    <button type="submit" class="form-control form-control-lg btn-success" name="submit">
                        <i class="fas fa-upload"></i>
                    </button>
                </div>
            </form>
            <small class="mt-2">Currently, only PHP language are acceptable and make sure your file in the stated language.</small>
        </div>
    </div>
</div>
